...
// magic numbers
const (
	MainnetMagic wire.BitcoinNet = 0x0488B21E
	TestnetMagic wire.BitcoinNet = 0x0488ADE4
...
func init() {
	...
	MainNetParams.PubKeyHashAddrID = []byte{51} // starting with 'D'
	MainNetParams.ScriptHashAddrID = []byte{28}
	MainNetParams.PrivateKeyID = []byte{55}
