...
// magic numbers
const (
	MainnetMagic wire.BitcoinNet = 0x3df6d1b7
...
func init() {
	...
	MainNetParams.PubKeyHashAddrID = []byte{95} // starting with 'D'
	MainNetParams.ScriptHashAddrID = []byte{130}
	MainNetParams.PrivateKeyID = []byte{113}
